"""
Django settings for rp_projeto project.
...
WSGI_APPLICATION = 'rp_projeto.wsgi.application'
...
# Definir URL para arquivos estáticos
STATIC_URL = '/static/'
